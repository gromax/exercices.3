...
### 3 zones de codes
  ...
  * **initialisation :** on y initisalise les variables aléatoires qui rendent l'exercice unique.
...
On utilise une langage fait de balises, comme en html.
  ...
  * D'autres balises sont auto-fermantes : `<bloc/>`
...
***Important :** On interdit les noms de variables commençant par `__`*.
...
On dispose du raccourci `@__v` désignant l'item de `@a` en cours de lecture et `@__i` désignant l'indice.
