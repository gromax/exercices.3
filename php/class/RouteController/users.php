...
class users
{
    ...
    /**
     * Récupère la liste des utilisateurs accessibles à l'utilisateur connecté
     * @return array|false La liste des utilisateurs ou false en cas d'erreur
     */
    ...
    /**
     * Récupère les informations d'un utilisateur spécifique en interne
     ...
     * @return array|false Le message de succès ou false en cas d'erreur
     */
     ...
     * @return array|false Les données de l'utilisateur inséré ou false en cas d'erreur
     */
     ...
     * @return array|false Les données de l'utilisateur mis à jour ou false en cas d'erreur
     */
    ...
    /**
     * Permet à un utilisateur de réinitialiser son mot de passe via son email
     * @return array|false Le message de succès ou false en cas d'erreur
     */
     ...
     * @param InitKey $key La clé de réinitialisation
